                ...
                {COVERS.map((cover, index) => (
                  ...
                  >
                    <span className="rv-cover-art">
                      <img src={cover.asset} alt={cover.alt} />
                      <i className="rv-cover-shine" />
                      <i className="rv-particle rv-particle-one">✦</i>
                      <i className="rv-particle rv-particle-two">✧</i>
                      <i className="rv-particle rv-particle-three">✦</i>
                    </span>
                  </button>
                ))}
              </div>
